...
<header class="bg-primary-700 md:fixed z-40 inset-x-0 top-0 py-4 md:py-0">
    <div class="container bg-xbg-800">
        <div class="md:h-16 flex flex-col md:flex-row items-center justify-between">
            <a href="<?= home_url() ?>" class="flex items-center text-xamber-700">
            ...
            <div class="flex items-center">
                <template x-if="cart.length > 0">
                    <a href="<?= home_url('cart') ?>" class="flex items-center mt-3 md:mt-0 mr-6">
                ...
                <a href="<?= home_url('delivery') ?>" class="flex items-center mt-3 md:mt-0">
